 ...
 */
abstract public class SingleCellularAutomaton extends Simulator
{
	protected CellularSpace cells; 
	protected StateSet stateSet;
	protected boolean initialized = false;
	
	protected SingleTransitionFunction delta;
	protected int ti = 0;
	 ...
	 */
	public SingleTransitionFunction getDelta() {
		return delta;
	}
	 ...
	 */
	public void setDelta(SingleTransitionFunction delta) {
		this.delta = delta;
