 ...
 */
abstract public class SingleTransitionFunction 
{
	protected StateSet states;
	protected SingleCellularAutomaton a;

	
	public SingleTransitionFunction() {
		this.defineStates();
	}

	/**
	 * defines the state set for this transition function. This method has to 
	 * be implemented by all {@link SingleTransitionFunction}-realizations.
	 */
	 ...
	 * function.
	 */
	public SingleCellularAutomaton getAutomaton() {
		return a;
	}
	 ...
	 * 
	 * @param cellularSingleAutomaton
	 */
	public void setAutomaton(SingleCellularAutomaton cellularSingleAutomaton) {
		this.a = cellularSingleAutomaton;
	}
	 ...
	 * SingleTransitionFunction#states} will be executed for each cell.
	 * 
	 ...
	 * Additionally the method {@link SingleTransitionFunction#step(int)} will be 
	 ...
	 * methods {@link SingleTransitionFunction#step(Cell, int)} and {@link 
	 * SingleTransitionFunction#step(int)} are executed. This method can be 
